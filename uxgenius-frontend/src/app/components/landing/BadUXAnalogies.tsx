...
import { HiMap, HiCake, HiPhone, HiShoppingBag } from 'react-icons/hi2';
               ...
               <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
                         {analogies.map((analogy, index) => (
                              <div key={index} className="text-center p-6 sm:p-8 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                                   <div className="mb-4 sm:mb-6 text-blue-600 flex justify-center">
                                        {analogy.icon}
                                   </div>
